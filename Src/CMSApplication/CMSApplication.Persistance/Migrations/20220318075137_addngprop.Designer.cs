...
namespace CMSApplication.Persistance.Migrations
{
    ...
    [Migration("20220318075137_addngprop")]
    partial class addngprop
    {
            ...
            modelBuilder.Entity("CMSApplication.Domain.Entities.MainEntities.UserEntities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "admin",
                            ConcurrencyStamp = "61ff082a-4667-48cc-af09-14130860fe96",
                            IsDeleted = false,
                            Name = "Admin",
                        ...
                        {
                            Id = "user",
                            ConcurrencyStamp = "009a9abb-613b-4a48-be80-f13d4c56e2cd",
                            IsDeleted = false,
                            Name = "User",
                            NormalizedName = "USER"
                        });
